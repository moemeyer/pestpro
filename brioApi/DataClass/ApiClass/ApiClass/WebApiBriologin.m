...
-(NSData*)getWebsocketAuthToken
{
	...
	NSData *result = [self.manager startReqest: request withResponse:nil withError:&error];
	NSError *errorJson = nil;
	NSDictionary *dic = [NSJSONSerialization JSONObjectWithData:result options:0 error:&errorJson];
	if(errorJson != nil)
		@throw [NSException exceptionWithName:errorJson.domain reason:errorJson.localizedDescription userInfo:errorJson.userInfo];
